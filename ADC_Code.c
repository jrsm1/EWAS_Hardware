...
/* Standard Includes */
#include <stdint.h>
#include <stdbool.h>/* DriverLib Includes */
#include <ti/devices/msp432p4xx/driverlib/driverlib.h>
...
void freq_Config(int freq)
{
    ...
    case 256:                                           //sampling rate of 256Hz
        setDCOTo16MHz();                                //Set DCO frequency to 16MHz
    ...
    case 20000:                                         //sampling rate of 20,000Hz
        setDCOTo24MHz();                                //Set DCO frequency to 24MHz
